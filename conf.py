...
BLOG_TITLE = "Ignotum Per Ignotius"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://necromuralist.github.io/Ignotum-Per-Ignotius/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://necromuralist.github.io/Bowling-For-Data/"
BLOG_EMAIL = "cloisteredmonkey.jmark@slmail.me"
BLOG_DESCRIPTION = "Unexplaining the unexplainable."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (
            (
                ("https://necromuralist.github.io/", "Necromuralist Home"),
                ("https://necromuralist.github.io/Visions-Voices-Data/", "Visions, Voices, Data"),                
            ),
            "Cloistered Monkey Sites"
        ),
    ),
}
...
GITHUB_DEPLOY_BRANCH = 'built-pages'
